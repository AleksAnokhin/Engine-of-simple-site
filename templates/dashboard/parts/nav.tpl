	...
	<div class="side-navbar-wrapper">
		...
		<div class="main-menu">
			<ul id="side-main-menu" class="side-menu list-unstyled">
				<li>
					<a href="<?= MAIN. 'dashboard/composer' ?>" >Композиторы</a>
				</li>
				<li>
					<a href="<?= MAIN . 'dashboard/opera' ?>">Оперы</a>
				</li>
				<!--<li>
				...
				<li>
					...
					<ul id="libs" class="collapse list-unstyled ">
						<li>
							<a href="<?= MAIN . 'dashboard/country' ?>">Страны</a>
						</li>
						<li>
							<a href="<?= MAIN . 'dashboard/genre' ?>">Муз. направления</a>
						</li>
					</ul>
				</li>
			</ul>
			...
			<div class="container-fluid">
				<div class="navbar-holder d-flex align-items-center justify-content-between">
					<div class="navbar-header">
						...
						<a href="<?= MAIN . 'dashboard' ?>" class="navbar-brand">
