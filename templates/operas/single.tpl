<div class="content-header">
    <div class="content-header-top-menu">
        <?php if(isset($data['main'][0]['fullName'])) : ?>
        <span class="title title-big"><?= $data['main'][0]['fullName'] ?></span>
        <?php else : ?>
        <span class="title title-big"><?= $data['composer']['fullName'] ?></span>
        <?php endif; ?>
        <div class="btn-back" data-backfunc="customBackFunc"><a href="<?= MAIN . 'home' ?>"> &lt;&lt;&nbsp;Назад</a></div>
        <ul>
